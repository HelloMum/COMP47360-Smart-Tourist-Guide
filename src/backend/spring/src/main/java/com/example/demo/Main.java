...
public class Main {
    ...
    private static Map<Integer, Integer> getRegionBusyness(double lat, double lon) {
        for (int i = 0; i < REGION_BOUNDARIES.length; i++) {
            ...
            if (lat >= bounds[0] && lat <= bounds[2] && lon >= bounds[1] && lon <= bounds[3]) {
                switch (i) {
                    case 0: return BUSYNESS_REGION_1;
                    case 1: return BUSYNESS_REGION_2;
                    case 2: return BUSYNESS_REGION_3;
                    case 3: return BUSYNESS_REGION_4;
                }
            }
        }
    ...
    public static void main(String[] args) {
        try {
            ...
            availabilityMap.put(1, List.of(new TimeSlot(LocalTime.of(0, 0), LocalTime.of(23, 59))));
            availabilityMap.put(2, List.of(new TimeSlot(LocalTime.of(0, 0), LocalTime.of(23, 59))));
            availabilityMap.put(3, List.of(new TimeSlot(LocalTime.of(0, 0), LocalTime.of(23, 59))));
            ...
            List<Event> events = List.of(
                    ...
                    new Event("Event 3", 1, LocalTime.of(11, 30), LocalTime.of(15, 0), 5, 10),
            ...
            List<Attraction> attractions = List.of(
                    ...
                    new Attraction("Attraction 2", 9.0, 1.0, "Mo-Fr 10:00-17:00", getRegionBusyness(9.0, 1.0)),
                    new Attraction("Attraction 3", 3.0, 2.0, "Mo-Fr 10:00-17:00", getRegionBusyness(3.0, 2.0)),
                    new Attraction("Attraction 4", 7.0, 6.0, "Mo-Fr 10:00-17:00", getRegionBusyness(7.0, 6.0)),
                    new Attraction("Attraction 5", 3.0, 9.0, "Mo-Th 12:00-19:00", getRegionBusyness(3.0, 9.0))
            );
            ...
            dayWiseAttractions.put(3, List.of(attractions.get(4))); // 修改这里，以便不超过索引范围

            Map<Integer, List<ScheduledEvent>> scheduledEventsPerDay = TimeSlotAllocation.timeSlotAllocationAlgorithm(dayWiseEvents, userAvailability, attractions);
