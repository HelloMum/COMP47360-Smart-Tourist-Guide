...
public class EventScraper {
    ...
    public List<EventData> fetchYelpEvents() {
        long startDate = System.currentTimeMillis() / 1000L; // 当前时间的时间戳
        RestTemplate restTemplate = new RestTemplate();
        String url = String.format("https://api.yelp.com/v3/events?location=%s&limit=%d&start_date=%d", location, limit, startDate);
